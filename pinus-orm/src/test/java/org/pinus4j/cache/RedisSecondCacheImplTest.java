...
public class RedisSecondCacheImplTest extends BaseTest {
    ...
    public void testGlobal() {
        ...
        data.add("aaa");
        data.add("bbb");
        secondCache.putGlobal(((DefaultQueryImpl) query).getWhereSql().getSql(), CLUSTER_KLSTORAGE, "testglobalentity", data);

        data = secondCache.getGlobal(((DefaultQueryImpl) query).getWhereSql().getSql(), CLUSTER_KLSTORAGE, "testglobalentity");
