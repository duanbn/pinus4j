...
public class ShardingStorageClientImpl implements IShardingStorageClient {
	...
	public <T> T findByPk(Number pk, Class<T> clazz, boolean useCache) {
		...
		if (ReflectUtil.isShardingEntity(clazz)) {
			return this.shardingQuery.findByPk(pk, clazz, useCache);
		} else {
			return this.globalQuery.getByPk(pk, clazz, useCache);
		}
	}
	...
	public <T> T findByPk(Number pk, Class<T> clazz, boolean useCache, EnumDBMasterSlave masterSlave) {
		...
		if (ReflectUtil.isShardingEntity(clazz)) {
			return this.shardingQuery.findByPk(pk, clazz, useCache, masterSlave);
		} else {
			return this.globalQuery.getByPk(pk, clazz, useCache, masterSlave);
		}
	}
	...
	public <T> List<T> findByPkList(List<? extends Number> pkList, Class<T> clazz, boolean useCache) {
		...
		if (ReflectUtil.isShardingEntity(clazz)) {
			return this.shardingQuery.findByPkList(pkList, clazz, useCache);
		} else {
			return this.globalQuery.findByPkList(pkList, clazz, useCache);
		}
	}
	...
	public <T> List<T> findByPkList(List<? extends Number> pkList, Class<T> clazz, boolean useCache,
		...
		if (ReflectUtil.isShardingEntity(clazz)) {
			return this.shardingQuery.findByPkList(pkList, clazz, useCache, masterSlave);
		} else {
			return this.globalQuery.findByPkList(pkList, clazz, useCache, masterSlave);
		}
	}
	...
	public <T> T findByPk(Number pk, IShardingKey<?> shardingKey, Class<T> clazz, boolean useCache) {
		...
		return this.shardingQuery.findByPk(pk, shardingKey, clazz, useCache);
	}
	...
	public <T> T findByPk(Number pk, IShardingKey<?> shardingKey, Class<T> clazz, boolean useCache,
		...
		return this.shardingQuery.findByPk(pk, shardingKey, clazz, useCache, masterSlave);
	}
	...
	public <T> List<T> findByPkList(List<? extends Number> pkList, IShardingKey<?> shardingKey, Class<T> clazz,
		...
		return this.shardingQuery.findByPkList(pkList, shardingKey, clazz, useCache);
	}
	...
	public <T> List<T> findByPkList(List<? extends Number> pkList, IShardingKey<?> shardingKey, Class<T> clazz,
		...
		return this.shardingQuery.findByPkList(pkList, shardingKey, clazz, useCache, masterSlave);
	}
