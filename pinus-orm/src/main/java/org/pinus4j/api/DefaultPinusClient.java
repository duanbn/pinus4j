...
public class DefaultPinusClient implements PinusClient {
    ...
    public void saveBatch(List<Object> entityList) {
        ...
        for (Object entity : entityList) {
            if (ReflectUtil.isShardingEntity(entity.getClass())) {
        ...
        if (!globalList.isEmpty()) {
            ...
            for (Map.Entry<String, List<Object>> entry : clusterEntityMap.entrySet()) {
                this.globalUpdater.saveBatch(entry.getValue(), entry.getKey());
            }
        }
    ...
    public void delete(Object entity) {
        ...
        if (ReflectUtil.isShardingEntity(clazz)) {
            ...
            String clusterName = ReflectUtil.getClusterName(clazz);
            Object shardingValue = ReflectUtil.getShardingValue(entityPk);
